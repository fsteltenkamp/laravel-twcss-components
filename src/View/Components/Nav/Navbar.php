...
class Navbar extends Component
{
    ...
    public function __construct(
        ...
        $edgeBorderClass = match (true) {
            ...
            $this->stickyBottom => 'border-t',
            default => 'border-b',
        };

        $stickyClasses = implode(' ', array_filter([
            $this->stickyTop ? 'sticky top-0' : null,
            $this->stickyBottom ? 'fixed inset-x-0 bottom-0' : null,
            ($this->stickyTop || $this->stickyBottom) ? $this->zIndexClass : null,
        ]));
        ...
        // Share the navbar theme with child components
        ViewFacade::share(['navbarTheme' => $this->theme]);
    }
