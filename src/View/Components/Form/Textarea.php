...
class Textarea extends Component
{
    ...
    public function __construct(
        ...
        $themeMap = [
            'slate'    => 'border-slate-300 bg-slate-50 text-slate-900 placeholder-slate-400 focus:border-slate-400 focus:ring-slate-400 dark:border-slate-600 dark:bg-slate-950 dark:text-slate-100 dark:placeholder-slate-500 dark:focus:border-slate-400 dark:focus:ring-slate-400',
            'gray'     => 'border-gray-300 bg-gray-50 text-gray-900 placeholder-gray-400 focus:border-gray-400 focus:ring-gray-400 dark:border-gray-600 dark:bg-gray-950 dark:text-gray-100 dark:placeholder-gray-500 dark:focus:border-gray-400 dark:focus:ring-gray-400',
            'zinc'     => 'border-zinc-300 bg-zinc-50 text-zinc-900 placeholder-zinc-400 focus:border-zinc-400 focus:ring-zinc-400 dark:border-zinc-600 dark:bg-zinc-950 dark:text-zinc-100 dark:placeholder-zinc-500 dark:focus:border-zinc-400 dark:focus:ring-zinc-400',
            'neutral'  => 'border-neutral-300 bg-neutral-50 text-neutral-900 placeholder-neutral-400 focus:border-neutral-400 focus:ring-neutral-400 dark:border-neutral-600 dark:bg-neutral-950 dark:text-neutral-100 dark:placeholder-neutral-500 dark:focus:border-neutral-400 dark:focus:ring-neutral-400',
            'stone'    => 'border-stone-300 bg-stone-50 text-stone-900 placeholder-stone-400 focus:border-stone-400 focus:ring-stone-400 dark:border-stone-600 dark:bg-stone-950 dark:text-stone-100 dark:placeholder-stone-500 dark:focus:border-stone-400 dark:focus:ring-stone-400',
